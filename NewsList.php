...
<h1><img src="style/li.gif" width="15" height="15" />News</h1>

<?php           
 $sql="select * from News where validFlag='1' order by Id desc ";
 $db->query($sql);
 $PagePn=new page($db);
 ...
 for($i=$BeginRcd;$i<$EndRcd;$i++){   
  ...
  echo"<li><a href=\"NewsDetail.php?NewsId=".$db->getValue("Id",$i)."\">".$db->getvalue("Title",$i)."</a>  <span class='time'>".DateTo4($db->getvalue("Appdate",$i))."</span></li>\n";	 
 }	
